<?php
/*
Plugin Name: Titan region y comuna Chile
Plugin URI: https://vtorres.cl
Description: Plugin que permite agregar al checkout de woocommerce región y comunas Chilenas.
Version: 1.0.1
...
define('TITAN_NOMBRE', 'region-comuna');




//Archivos externos.
function titan_regiones_chilenas($states) {
	$states['CL'] = array(
...
function titan_ciudades_chilenas ( $fields ) {
...
function titan_campos_checkout( $fields ) {
...
add_filter('woocommerce_checkout_fields' , 'titan_campos_checkout');
add_filter('woocommerce_states', 'titan_regiones_chilenas');
add_filter('woocommerce_checkout_fields', 'ciudades_chilenas');
add_filter('woocommerce_default_address_fields', 'titan_ciudades_chilenas');
//Archivos externos.
//wp_register_style( 'TITAN_NOMBRE', '/includes/' );

//Archivos de estilos y script.
function titan_estilos_plugin_region_comuna()
{

    wp_register_style('titan_style_region', plugins_url('/includes/css/titan-style_region.css', __FILE__));
    wp_enqueue_style('titan_style_region');

    wp_register_script('titan_js_region', plugins_url('/includes/js/titan_comuna.js', __FILE__));
    wp_enqueue_script('titan_js_region', array('jquery'), true);
    

}

add_action('wp_enqueue_scripts', 'titan_estilos_plugin_region_comuna');
